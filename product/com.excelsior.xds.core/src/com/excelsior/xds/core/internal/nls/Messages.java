package com.excelsior.xds.core.internal.nls;
...
{
    private static final String BUNDLE_NAME = "com.excelsior.xds.core.internal.nls.messages"; //$NON-NLS-1$
    ...
    public static String ExternalResourceManager_UpdateOfProblemMarkers;
    ...
    public static String SdkIniFileWriter_ComentPrjFolder;
    public static String SdkIniFileWriter_ComentMainFolder;
    ...
    public static String SdkIniFileWriter_ComentProfilerPath;
    ...
    public static String SdkIniFileWriter_CommentToolCodepage0;
    public static String SdkIniFileWriter_CommentToolCodepage1;
    ...
    public static String BuilderUtils_DeleteMarkers;
    public static String BuilderUtils_BuildingProject;
    public static String BuilderUtils_ReBuildingProjectAndRefreshingLibrary;
    public static String BuilderUtils_RefreshingCompilationSet;
    public static String BuilderUtils_RefreshingCompilationSetAndRefreshingLibrary;
