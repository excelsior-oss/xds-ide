...
public class AstPragmaElseStatement extends AstPragmaConditionalStatement implements IAstFrameChild
{
    private IAstFrameNode frameNode;
 
    public AstPragmaElseStatement(ModulaCompositeType<AstPragmaElseStatement> elementType) {
        super(elementType);
    }
