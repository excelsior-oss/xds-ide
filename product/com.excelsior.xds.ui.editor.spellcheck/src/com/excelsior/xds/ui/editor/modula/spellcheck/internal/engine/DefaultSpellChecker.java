 ...
 *******************************************************************************/
package com.excelsior.xds.ui.editor.modula.spellcheck.internal.engine;
...
public class DefaultSpellChecker implements ISpellChecker {
	 ...
	 */
	public DefaultSpellChecker(Locale locale) {
	...
	public void execute(final ISpellEventListener listener, final ISpellCheckIterator iterator) {
		...
		final boolean ignoreDigits= PreferenceKeys.PKEY_SPELLING_IGNORE_DIGITS.getStoredBoolean();
		final boolean ignoreMixed= PreferenceKeys.PKEY_SPELLING_IGNORE_MIXED.getStoredBoolean();
		final boolean ignoreSentence= PreferenceKeys.PKEY_SPELLING_IGNORE_SENTENCE.getStoredBoolean();
		final boolean ignoreUpper= PreferenceKeys.PKEY_SPELLING_IGNORE_UPPER.getStoredBoolean();
		final boolean ignoreURLS= PreferenceKeys.PKEY_SPELLING_IGNORE_URLS.getStoredBoolean();
		final boolean ignoreNonLetters= PreferenceKeys.PKEY_SPELLING_IGNORE_NON_LETTERS.getStoredBoolean();
		final boolean ignoreSingleLetters= PreferenceKeys.PKEY_SPELLING_IGNORE_SINGLE_LETTERS.getStoredBoolean();
		final int problemsThreshold= PreferenceKeys.PKEY_SPELLING_PROBLEMS_THRESHOLD.getStoredInt();
